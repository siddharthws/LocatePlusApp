...
public class TinyDB {
    ...
    public ArrayList<MarkerObject> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<MarkerObject> objects =  new ArrayList<MarkerObject>();

    	for(String jObjString : objStrings){
    		MarkerObject value  = (MarkerObject) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<MarkerObject> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<>();
    	for(MarkerObject obj : objArray){
